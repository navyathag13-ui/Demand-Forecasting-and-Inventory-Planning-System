...
def build_inventory_plan(
    ...
    lead_time_weeks, z_score, ordering_cost, unit_value, holding_cost_pct, review_period_weeks
    ...
    plan["recommended_order_qty"] = (
        plan["demand_used"] * (lead_time_weeks + review_period_weeks) + plan["safety_stock"]
    ).round(2)
